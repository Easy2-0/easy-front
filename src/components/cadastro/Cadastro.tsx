...
const Cadastro = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-c-bg flex items-center justify-center px-6 py-6">
      ...
      {/* Blobs decorativos */}
      <div className="absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full bg-c-accent opacity-10 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-40 -left-20 w-[600px] h-[600px] rounded-full bg-c-accent opacity-[0.07] blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-[420px] flex flex-col gap-5">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-c-text/50 text-xs tracking-wide">Comece sua jornada financeira</p>
        </div>
